...
hs_data = pd.read_table(
    "../../CD4_w_protein/hotspot/hotspot_threshold.txt", index_col=0
)

hs_data_shuffled = pd.read_table(
    "../../CD4_w_protein/hotspot/hotspot_shuffled.txt", index_col=0
)
...
hs_pairs = pd.read_table(
    "../../CD4_w_protein/hotspot/hotspot_pairs_z_null.txt.gz", index_col=0
)
