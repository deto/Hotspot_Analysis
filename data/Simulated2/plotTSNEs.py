...
counts_file = "rep3/observed_counts.txt.gz"
cell_effects_file = "rep3/cell_effects.txt"
...
for i in range(5):
    ...
    plt.scatter(tsne_vals[:, 0], tsne_vals[:, 1], s=2, c=ce, vmin=0, vmax=1)
    #plt.scatter(umap_vals[:, 0], umap_vals[:, 1], s=2, c=ce, vmin=0, vmax=1)
    plt.xticks([])
    plt.yticks([])
